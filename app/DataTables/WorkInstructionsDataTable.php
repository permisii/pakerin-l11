        ...
        return (new EloquentDataTable($query))
            ...
            ->addColumn('status', function (WorkInstruction $workInstruction) {
                return match ($workInstruction->status) {
                    WorkInstructionStatusEnum::Draft => '<span class="badge badge-warning">Draft</span>',
                    WorkInstructionStatusEnum::Submitted => '<span class="badge badge-success">Submitted</span>',
                    WorkInstructionStatusEnum::Rejected => '<span class="badge badge-danger">Rejected</span>',
                    default => '-',
                };
            })
